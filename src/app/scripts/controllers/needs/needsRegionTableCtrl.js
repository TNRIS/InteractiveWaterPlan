...
angular.module('iswpApp')
  .controller('NeedsRegionTableCtrl', function ($scope, needsData) {
    ...
    $scope.mapDescription = 'Map shows geographic center of entities with identified water needs<span class="note-marker">*</span> in <strong>Region '+region+'</strong> (water system service area boundaries may extend outside of county).';
