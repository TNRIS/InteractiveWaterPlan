Ext.define('ISWP.controller.Main', {
    ...
    loadThemeIntoMap: (themeName) ->
        ...
        #Server side:
        #   basically we could make our own Control class that 
        #    uses an OpenLayers.Request.GET call to our controller
        #       passing along the WMS service request url generated by WMSGetFeatureInfo
        #       then the controller calls that and returns the result 
