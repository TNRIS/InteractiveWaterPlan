...
angular.module('iswpApp')
  .factory('StrategySourceService', function SourceService($http, API_PATH) {
    var service = {};
    ...
    service.getSources = function(sourceIds) {
      ...
      return _.where(service.sources, function (e) {
        return _.contains(idArr, e.MapSourceId);
      });
    };

    // service.search = function(namePart) {
    //   var requestPath = API_PATH + 'sources/strategy/search?name=' + namePart;
