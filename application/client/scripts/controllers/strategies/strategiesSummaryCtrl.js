...
angular.module('iswpApp').controller('StrategiesSummaryCtrl',
  function ($scope, strategiesData, TreeMapFactory, SUMMARY_TABLE_COLS, ISWP_VARS, API_PATH) {

    $scope.heading = 'Regional Summary of Recommended Water Management Supply Strategies';
