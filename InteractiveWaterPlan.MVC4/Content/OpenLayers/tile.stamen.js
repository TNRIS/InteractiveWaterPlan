 ...
 * Modified to include layerName option in OpenLayers.Layer.Stamen implementation
 */
...
if (typeof OpenLayers === "object") {
    ...
    OpenLayers.Layer.Stamen = OpenLayers.Class(OpenLayers.Layer.OSM, {
        initialize: function(name, layerName, options) {
            var provider = getProvider(name),
                url = provider.url,
                subdomains = provider.subdomains,
                hosts = [];
            ...
            return OpenLayers.Layer.OSM.prototype.initialize.call(this, layerName, hosts, options);
        }
    });
}
